...
import numpy as np
import copy
from MRM_importData_LOWESS_Smoothing_NEW import importData
...
#            f.write(htmlURL)
    ...
    # add matplotlib figure (bar plot)                       
    def addmpl1(self):
        try:
    ...
    def integrate(self):
        try:
            ...
            self.addmpl1() # problems here, crashes when using
            self.addmpl2()
        except:
            QMessageBox.critical(self, "ERROR","An error occurred. Please try again")           
