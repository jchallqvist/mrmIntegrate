...
#create a canvas to put a figure and toolbar, but do not draw anything yet
        ...
        # plot on figure
        '''Here'''
        self.PB_plotTrans.clicked.connect(self.f_plotTrans)
        '''stop'''
...
#        except NameError:
    ...
    def f_plotTrans(self):
        try:
            self.PB_plotTrans.clicked.connect(self.addmpl)
            if
            
        self.PB_plotTrans.clicked.connect(self.rmmpl1)
        self.PB_plotTrans.clicked.connect(self.rmmpl2)
