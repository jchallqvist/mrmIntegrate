...
#Useful links:
#https://github.com/Werkov/PyQt4/blob/master/examples/mainwindows/application/application.py
...
#create a canvas to put a figure and toolbar, but do not draw anything yet
        ...
        self.PB_reload.clicked.connect(self.f_reloadData)
...
#            print(counter1)            
    ...
    def f_saveFile(self):
       ...
       #add exception for when empty file
