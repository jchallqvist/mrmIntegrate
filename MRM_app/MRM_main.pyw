...
#        mplib.pyplot.figure(2)
#        colorsX = mplib.cm.rainbow(np.linspace(0,1,len(filesInFolder)))        
#        for sampleNr in range(len(filesInFolder)):
#            mplib.pyplot.fill_between(xTempAll[sampleNr], 0, yTempAll[sampleNr], facecolor = colorsX[sampleNr], alpha = 0.1)
#            mplib.pyplot.plot(xTempAll[sampleNr], yTempAll[sampleNr], color = colorsX[sampleNr], linewidth = 0.5)
